...
public class IllegalSimplifiedRingDependencyIT extends AbstractJavaPluginIT {
    ...
    public void testIllegalRingDependencies() throws RuleException {
        ...
        assertThat((TypeDescriptor) rows.get(0).get("SourceType")).is(new HamcrestCondition<>(typeDescriptor(Application1.class)));
        ...
        assertThat((TypeDescriptor) rows.get(2).get("TargetType")).is(new HamcrestCondition<>(typeDescriptor(Infrastructure1.class)));
