...
| jmolecules-architecture-layered            | jmolecules-layered:Default 
| jmolecules-architecture-onion (Classical)  | jmolecules-onion-classical:Default 
| jmolecules-architecture-onion (Simplified) | jmolecules-onion-simplified:Default  
...
* The concepts mentioned in this section are part of `jmolecules-onion-classical:Defaul`
...
* DomainEvent
** Supported as Package- and Type-Annotation and Interface
